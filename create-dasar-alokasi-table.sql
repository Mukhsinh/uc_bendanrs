-- Script untuk membuat tabel Dasar_Alokasi
-- Tabel ini akan menyimpan konfigurasi dasar alokasi untuk setiap unit kerja
...
CREATE TABLE IF NOT EXISTS "Dasar_Alokasi" (
  ...
  CONSTRAINT fk_dasar_alokasi_unit_kerja 
    FOREIGN KEY ("Unit_Kerja_ID") 
    REFERENCES unit_kerja(id) 
    ON DELETE CASCADE,
    
  CONSTRAINT fk_dasar_alokasi_data_kegiatan 
    FOREIGN KEY ("Data_Kegiatan_ID") 
    REFERENCES "Data_Kegiatan"(id) 
    ON DELETE CASCADE
);

-- 2. Buat tabel Distribusi_Biaya untuk menyimpan hasil perhitungan
CREATE TABLE IF NOT EXISTS "Distribusi_Biaya" (
  ...
  -- Foreign key constraints
  CONSTRAINT fk_distribusi_biaya_unit_kerja 
    FOREIGN KEY ("Unit_Kerja_ID") 
    REFERENCES unit_kerja(id) 
    ON DELETE CASCADE,
    
  CONSTRAINT fk_distribusi_biaya_data_kegiatan 
    FOREIGN KEY ("Data_Kegiatan_ID") 
    REFERENCES "Data_Kegiatan"(id) 
    ON DELETE CASCADE
);
...
CREATE INDEX IF NOT EXISTS idx_dasar_alokasi_data_kegiatan_id ON "Dasar_Alokasi"("Data_Kegiatan_ID");
...
CREATE INDEX IF NOT EXISTS idx_distribusi_biaya_data_kegiatan_id ON "Distribusi_Biaya"("Data_Kegiatan_ID");
...
-- 7. Buat function untuk generate dasar alokasi otomatis
...
-- 8. Buat function untuk menghitung distribusi biaya
