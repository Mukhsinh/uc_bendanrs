...
Write-Host "⚙️ LANGKAH 3: JALANKAN SCRIPT MEMBUAT FUNCTION" -ForegroundColor Yellow
...
Write-Host "📊 LANGKAH 5: PASTIKAN ADA DATA" -ForegroundColor Yellow
...
Write-Host ""
Write-Host "-- Jika tidak ada data, buat sample data:" -ForegroundColor Cyan
Write-Host "INSERT INTO unit_kerja (kode, nama, kategori, luas_ruangan) VALUES" -ForegroundColor Cyan
Write-Host "('UK001', 'Direktur', 'Pusat Biaya', 50.0)," -ForegroundColor Cyan
Write-Host "('UK002', 'Komite PPI', 'Pusat Biaya', 30.0)," -ForegroundColor Cyan
Write-Host "('UK003', 'Unit IT', 'Pusat Biaya', 40.0);" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "✅ Tabel Dasar_Alokasi dibuat" -ForegroundColor Green
Write-Host "✅ Tabel Distribusi_Biaya dibuat" -ForegroundColor Green
