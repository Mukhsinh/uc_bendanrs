  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-2">
        <h1 className="text-3xl font-bold tracking-tight text-slate-900">Kalkulasi Biaya Radiologi</h1>
      ...
      <Card className="border border-sky-100 bg-[#F8FBFF] shadow-sm">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl font-semibold text-slate-800">Kalkulasi Biaya Radiologi</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <label htmlFor="radiologi-import" className="cursor-pointer">
            ...
            <Input id="radiologi-import" type="file" accept=".csv,.xlsx" onChange={handleImport} className="hidden" />
            <Button
              variant="destructive"
