...
interface LaboratoriumEksternal {
  id: string;
  tenant_id: string;
  user_id: string;
  tahun: number;
...
const DaftarLaboratoriumEksternal = () => {
  ...
  const handleEdit = (item: LaboratoriumEksternal) => {
  ...
  const handleDownloadTemplate = () => {
    ...
    const sampleData = [
      ["Lab.Eks.001", "Pemeriksaan Darah Lengkap", "50000", "30000", "20000"],
      ["Lab.Eks.002", "Tes Urine Lengkap", "40000", "25000", "15000"],
    ];

    const ws = XLSX.utils.aoa_to_sheet([headers, ...sampleData]);
    const wb = XLSX.utils.book_new();
    XLSX.utils.book_append_sheet(wb, ws, "Template Lab Eksternal");
    XLSX.writeFile(wb, "template_laboratorium_eksternal.xlsx");
  };
  ...
  const handleExport = async () => {
    ...
    await downloadReport({
      title: "Laporan Daftar Laboratorium Eksternal",
      subtitle: `Data tahun ${tahun}`,
      filename: `laboratorium_eksternal_${tahun}`,
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <CardTitle>Daftar Laboratorium Eksternal</CardTitle>
              <CardDescription>
                Kelola data pemeriksaan laboratorium eksternal dengan tarif otomatis
              </CardDescription>
            </div>
          ...
          <div className="flex flex-wrap items-center gap-2 mb-3">
            ...
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
              ...
              <DialogContent className="max-w-2xl">
                <DialogHeader>
                  <DialogTitle>
                    {editingId ? "Edit" : "Tambah"} Laboratorium Eksternal
                  </DialogTitle>
                  <DialogDescription>
