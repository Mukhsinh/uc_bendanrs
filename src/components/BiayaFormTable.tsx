                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input type="number" step="0.0I need to complete the file. Let me finish the BiayaFormTable component:

<dyad-write path="src/components/BiayaFormTable.tsx" description="Completing the BiayaFormTable component">
"use client";
