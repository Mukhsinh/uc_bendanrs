  ...
  useEffect(() => {
    if (editingBiaya) {
      form.reset({
        ...
        biaya_pemeliharaan_b<dyad-write path="src/components/BiayaFormTable.tsx" description="Updating BiayaFormTable with revised form structure according to the specified grouping">
"use client";
