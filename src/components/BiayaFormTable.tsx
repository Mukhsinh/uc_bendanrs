...
const BiayaFormTable: React.FC = () => {
        ...
        complete: async (results) => {
          try {
            ...
            for (const row of results.data) {
              ...
              importedData.push({
                tahun,
                biaya_gaji_tunjangan: parseFloat(row["Biaya Gaji & Tunjangan"]) || 0,
                ...
                biaya_makan_karyawan: parseFloat(row["Biaya Makan Karyawan"]) || 0,
                biaya_makan_pasien: parseFloat(row["Biaya Makan Pasien"]) || 0,
                biaya_rumah_tangga: parseFloat(row["Biaya Rumah Tangga"]) || 0,
                biaya_cetak: parseFloat(row["Biaya Cetak"]) || 0,
                biaya_atk: parseFloat(row["Biaya ATK"]) || 0,
                ...
                biaya_pemeliharaan_bangunan: parseFloat(row["Biaya Pemeliharaan Bangunan"]) || 0,
                ...
                biaya_penyusutan_gedung: parseFloat(row["Biaya Penyusutan Gedung"]) || 0,
  ...
  const handleDownloadReport = () => {
    ...
    const dataToExport = biayaList.map(item => ({
      ...
      "Biaya Makan Pasien": item.biaya_makan_pasien || 0,
