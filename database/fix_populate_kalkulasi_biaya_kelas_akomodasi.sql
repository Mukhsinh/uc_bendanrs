...
BEGIN
    ...
    SELECT
        ...
        -- Biaya dari kalkulasi_biaya_akomodasi * dasar_alokasi_hari_rawat
...
IS 'Populate kalkulasi_biaya_kelas_akomodasi dengan rumus alokasi_biaya_gizi: jumlah_kali_porsi_[kelas] / hari_rawat_[kelas] dari data_akomodasi_inap berdasarkan kode_unit_kerja, tahun, dan kelas. Prioritas: data user, lalu data master (user_id IS NULL)';
