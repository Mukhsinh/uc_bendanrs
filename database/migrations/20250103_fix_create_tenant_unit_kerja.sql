-- Migration: Fix create_tenant_with_admin function
-- Date: 2025-01-03
-- Description: Memperbaiki fungsi create_tenant_with_admin dengan menghapus INSERT default data yang tidak sesuai constraint
...
BEGIN
  ...
  -- Step 4: Log audit trail menggunakan tabel audit_trail yang ada
  RAISE NOTICE 'create_tenant_with_admin: Logging audit trail...';
  INSERT INTO audit_trail (
    ...
    'Tenant baru dibuat dengan admin user',
    v_tenant_id,
    NOW()
  );
...
'Membuat tenant baru dengan admin user. Hanya Super Admin yang dapat memanggil function ini. Default data unit kerja dan dasar alokasi tidak diinisialisasi otomatis karena memerlukan format yang spesifik sesuai constraint tabel.';
