-- ============================================================================
-- Migration: Recalculate JP Produk Layanan
-- Created: 2025-01-08
-- Description: Membuat fungsi untuk recalculate JP pada produk_layanan
--              untuk data yang sudah ada yang JP-nya belum terhitung
-- ============================================================================

-- Drop function jika sudah ada
DROP FUNCTION IF EXISTS public.recalculate_jp_produk_layanan(INTEGER, TEXT);
DROP FUNCTION IF EXISTS public.recalculate_jp_produk_layanan_rpc(INTEGER, TEXT);

-- ============================================================================
-- Fungsi untuk recalculate JP pada produk_layanan
-- ============================================================================
...
BEGIN
    ...
    FOR v_record IN 
        SELECT id, tahun, tindakan, ibs, laboratorium, radiologi, farmasi, 
               kamar_akomodasi, visite, konsultasi, jp_farmasi_prosentase
        FROM produk_layanan
...
-- Comment
COMMENT ON FUNCTION public.recalculate_jp_produk_layanan(INTEGER, UUID) IS 
'Menghitung ulang semua JP (Jasa Pelayanan) pada tabel produk_layanan berdasarkan data array tindakan, ibs, laboratorium, radiologi, farmasi, kamar_akomodasi, visite, dan konsultasi. Support filter berdasarkan tahun dan id.';

COMMENT ON FUNCTION public.recalculate_jp_produk_layanan_rpc(INTEGER, UUID) IS 
'RPC wrapper untuk recalculate_jp_produk_layanan yang bisa dipanggil dari frontend.';
