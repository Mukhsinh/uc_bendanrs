-- ============================================
-- FIX OPTIMIZED: manual_recalculate_bdrs dengan optimasi dan skip refresh
-- ============================================
-- Masalah: Statement timeout saat rekalkulasi BDRS dengan data besar
-- Solusi: 
--   1. Meningkatkan statement_timeout ke 10 menit (600000ms)
--   2. Skip refresh rekapitulasi_unit_cost untuk menghindari timeout tambahan
--   3. Optimasi query dengan index hints
...
BEGIN
  ...
  -- Jika tidak ada data_biaya, gunakan nilai default 0
...
-- VERIFICATION
-- ============================================
SELECT 'Fix optimized untuk manual_recalculate_bdrs completed successfully!' as status;
SELECT 'Perubahan: 1) Timeout 10 menit, 2) Skip refresh rekapitulasi, 3) Error handling lebih baik' as changes;
